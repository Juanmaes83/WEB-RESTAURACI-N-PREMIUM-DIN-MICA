...
(() => {
  ...
  function applyAll(){
    ...
    renderBrand();['hero','origin','atmosphere','chef'].forEach(slot=>renderMedia(slot,$(`[data-media-host="${slot}"]`)));buildOrbit();syncStudioInputs();renderDishList();renderMediaCards();
