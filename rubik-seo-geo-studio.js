...
(() => {
  ...
  function build(){
    ...
    panel.append(intro,el('p','seo-notice','Fase 1 · Preparación y previews. Los cambios SEO se guardan en el proyecto; su publicación en HTML llegará en Fase 2.'));
    ...
    field(home,'Idioma de las fórmulas','seo.site.defaultLanguage',{options:[['es','Español'],['en','English']]});
    ...
    const privacy=section('Revisión y privacidad','Los datos de contacto se omiten del schema hasta confirmarlos. Dirección y teléfono requieren también Ubicación activa.');
